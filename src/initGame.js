...
export default async function initGame() {
  ...
  k.loadSprite("facebook-logo", "./logos/facebook-logo.png");
  k.loadSprite("hackerrank-logo", "./logos/hackerrank-logo.png");
  ...
  k.loadSprite("c++-logo", "./logos/c++-logo.png");
  k.loadSprite("django-logo", "./logos/django-logo.png");
  k.loadSprite("flask-logo", "./logos/flask-logo.png");
  k.loadSprite("mysql-logo", "./logos/mysql-logo.png");
  k.loadSprite("sqlite-logo", "./logos/sqlite-logo.png");
  k.loadSprite("bashscript-logo", "./logos/bashscript-logo.png");
  k.loadSprite("powershell-logo", "./logos/powershell-logo.png");
  k.loadSprite("aws-logo", "./logos/aws-logo.png");
  k.loadSprite("gcp-logo", "./logos/gcp-logo.png");
  k.loadSprite("git-logo", "./logos/git-logo.png");
  k.loadSprite("render-logo", "./logos/render-logo.png");
  k.loadSprite("vercel-logo", "./logos/vercel-logo.png");
  k.loadSprite("project1", "./projects/project1.png");
  k.loadSprite("project2", "./projects/project2.png");
  k.loadSprite("project3", "./projects/project3.png");
  k.loadSprite("project4", "./projects/project4.png");
  k.loadSprite("project5", "./projects/project5.png");
  k.loadSprite("allprojects", "./projects/allprojects.png");
